...
const AddAppointment = ({ lastAppointmentId, onAddAppointment }) => {
  const clearData = {
    ownerName: "",
    petName: "",
    aptDate: "",
            ...
            <div className="flex justify-end">
              <button
                onClick={() => {
                  ...
                  newAppointment.aptDate = `${formData.aptDate}  ${formData.aptTime}`;
                  delete newAppointment.aptTime;
                  newAppointment.id = (
                    Number(lastAppointmentId) + 1
                  ).toString();
